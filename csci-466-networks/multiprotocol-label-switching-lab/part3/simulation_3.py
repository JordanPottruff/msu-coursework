...
if __name__ == '__main__':
    ...
    encap_tbl_D = {'H3':1}    # table used to encapsulate network packets into MPLS frames
    # table used to forward MPLS frames
    frwd_tbl_D = [
                    {'inL':0, 'inI':0, 'outL':2, 'outI':2},
                    {'inL':0, 'inI':1, 'outL':2, 'outI':2},
                    {'inL':1, 'inI':0, 'outL':2, 'outI':3},
                    {'inL':1, 'inI':1, 'outL':2, 'outI':3}
                 ]
    decap_tbl_D = {'lbl':None, 'outI':None}    # table used to decapsulate network packets from MPLS frames
    ...
    encap_tbl_D = {}
    frwd_tbl_D = [
                    {'inL':0, 'inI':0, 'outL':3, 'outI':1}
                 ]
    decap_tbl_D = {'lbl':None, 'outI':None}
    ...
    encap_tbl_D = {}
    frwd_tbl_D = [
                    {'inL':0, 'inI':1, 'outL':None, 'outI':2},
                    {'inL':1, 'inI':0, 'outL':None, 'outI':2},
                    {'inL':0, 'inI':0, 'outL':None, 'outI':2},
                    {'inL':1, 'inI':1, 'outL':None, 'outI':2}
                 ]
    decap_tbl_D = {'lbl':3, 'outI':2}
    router_d = Router(name='RD',
                              intf_capacity_L=[500,500,50],
                              encap_tbl_D = encap_tbl_D,
                              frwd_tbl_D = frwd_tbl_D,
                              decap_tbl_D = decap_tbl_D,
                              max_queue_size=router_queue_size)
