...
if __name__ == '__main__':
    ...
    encap_tbl_D = {'H2':1}    # table used to encapsulate network packets into MPLS frames
    # table used to forward MPLS frames
    frwd_tbl_D = [
                    {'inL':1, 'inI':0, 'outL':2, 'outI':1},
                    {'inL':2, 'inI':1, 'outL':None, 'outI':0}
                 ]
    decap_tbl_D = {'lbl':2, 'outI':0}    # table used to decapsulate network packets from MPLS frames
    ...
    encap_tbl_D = {'H1':1}
    frwd_tbl_D = [
                    {'inL':1, 'inI':1, 'outL':2, 'outI':0},
                    {'inL':2, 'inI':0, 'outL':None, 'outI':1}
                 ]
    decap_tbl_D = {'lbl':2, 'outI':1}
