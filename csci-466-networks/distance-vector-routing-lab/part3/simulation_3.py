...
if __name__ == '__main__':
    ...
    # routing table set up for router A
    ...
    # routing table set up for router B
    ...
    # routing table set up for router C
    ...
    # routing table set up for router D
